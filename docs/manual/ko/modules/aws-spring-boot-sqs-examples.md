...
[![Bluetape4k AWS spring boot sqs examples 아키텍처](../../assets/readme-diagrams/examples-aws-spring-boot-sqs-examples-architecture-01.png)](../../assets/readme-diagrams/examples-aws-spring-boot-sqs-examples-architecture-01.svg)

_배포본 README: [`examples/aws-spring-boot-sqs-examples/README.ko.md`](https://github.com/bluetape4k/bluetape4k-aws/blob/be4e6daea5654f84579955307ec56a58c8f405be/examples/aws-spring-boot-sqs-examples/README.ko.md)_
