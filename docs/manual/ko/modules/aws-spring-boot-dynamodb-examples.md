...
- [Emulator 기반 테스트](../../../../examples/aws-spring-boot-dynamodb-examples/src/test/kotlin/io/bluetape4k/aws/examples/spring/dynamodb/OrderControllerLocalStackTest.kt)
