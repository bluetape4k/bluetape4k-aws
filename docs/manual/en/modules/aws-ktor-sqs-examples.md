...
- [Floci integration test](../../../../examples/aws-ktor-sqs-examples/src/test/kotlin/io/bluetape4k/aws/examples/ktor/sqs/SqsExampleRoutesFlociTest.kt)
- [Example notes](../../../../examples/aws-ktor-sqs-examples/README.md)
