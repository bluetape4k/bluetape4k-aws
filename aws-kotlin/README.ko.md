...
![Java SDK v2 vs Kotlin SDK 비교 다이어그램 1](../docs/images/readme-diagrams/aws-kotlin-ko-diagram-01.svg)

### 클라이언트 생성 패턴 다이어그램

![클라이언트 생성 패턴 다이어그램 2](../docs/images/readme-diagrams/aws-kotlin-ko-diagram-02.svg)

### DSL 지원 서비스

![DSL 지원 서비스 3](../docs/images/readme-diagrams/aws-kotlin-ko-diagram-03.svg)

### 클라이언트 패턴 클래스 다이어그램

![클라이언트 패턴 클래스 다이어그램 4](../docs/images/readme-diagrams/aws-kotlin-ko-diagram-04.svg)
