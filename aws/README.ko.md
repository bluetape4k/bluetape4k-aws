...
![3단계 API 패턴 다이어그램 1](../docs/images/readme-diagrams/aws-ko-diagram-01.svg)

### 서비스별 지원 현황

![서비스별 지원 현황 2](../docs/images/readme-diagrams/aws-ko-diagram-02.svg)

### 3단계 API 패턴 클래스 다이어그램

![3단계 API 패턴 클래스 다이어그램 3](../docs/images/readme-diagrams/aws-ko-diagram-03.svg)
